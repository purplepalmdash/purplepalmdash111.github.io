...
$ mkdir themes
$ cd themes
$ git clone https://github.com/abhi1010/hyde-a
```
...
Just run `hugo --theme=hyde-a` to generate your site!
...
Hyde-A provides 8 built-in colour themes by default, with the option to define more in your own custom CSS.

![Hyde-A theme classes](https://github.com/abhi1010/hyde-a/blob/master/images/theme-colours.png)

### Tips

* If you've added `theme = "hyde-a"` to your `config.toml`, you don't need to keep using the `--theme=hyde-a` flag!
...
All feedback is welcome! Head over to the [issue tracker](https://github.com/abhi1010/hyde-a/issues).

### License

Open sourced under the [MIT license](https://github.com/abhi1010/hyde-a/blob/master/LICENSE).
